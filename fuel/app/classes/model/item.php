...
class Model_Item extends \Orm\Model
{
	...
	public static function validate($factory)
	{
		...
		$val->add_field('item_category_id', 'カテゴリー', "required|max_length[10]|item_number|category_num");
		$val->add_field('item_expire_seconds', 'アイテム有効期限(秒)', "required|max_length[10]|item_number");
