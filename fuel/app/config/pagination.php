...
return array(
	...
	'default'                     => array(
		...
		'first-link'              => "\t\t<a href=\"{uri}\" class=\"button-lightgray smaller\">{page}</a>\n",
		...
		'previous-link'           => "\t\t<a href=\"{uri}\" rel=\"prev\" class=\"button-lightgray smaller\">{page}</a>\n",

		'previous-inactive'       => "<span class=\"previous-inactive\">\n\t{link}\n</span>\n",
		'previous-inactive-link'  => "\t\t<a href=\"#\" rel=\"prev\" class=\"button-lightgray smaller\">{page}</a>\n",

		'regular'                 => "<span>\n\t{link}\n</span>\n",
		'regular-link'            => "\t\t<a href=\"{uri}\" class=\"button-lightgray smaller\">{page}</a>\n",

		'active'                  => "<span class=\"active\">\n\t{link}\n</span>\n",
		'active-link'             => "\t\t<a href=\"#\" class=\"button-lightgray smaller\">{page}</a>\n",

		'next'                    => "<span class=\"next\">\n\t{link}\n</span>\n",
		'next-marker'            => "&raquo;",
		'next-link'               => "\t\t<a href=\"{uri}\" rel=\"next\" class=\"button-lightgray smaller\">{page}</a>\n",

		'next-inactive'           => "<span class=\"next-inactive\">\n\t{link}\n</span>\n",
		'next-inactive-link'      => "\t\t<a href=\"#\" rel=\"next\" class=\"button-lightgray smaller\">{page}</a>\n",

		'last'                    => "<span class=\"last\">\n\t{link}\n</span>\n",
		'last-marker'             => "&raquo;&raquo;",
		'last-link'               => "\t\t<a href=\"{uri}\" class=\"button-lightgray smaller\">{page}</a>\n",
