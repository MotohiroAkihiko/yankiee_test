...
return array(
	...
	'groups' => array(
		 ...
		 */
		1   => array('name' => '検査者', 'roles' => array('user')),
		//50  => array('name' => 'Moderators', 'roles' => array('user', 'moderator')),
		100 => array('name' => '管理者', 'roles' => array('user', 'admin')),
	),
	 ...
	 */
	'login_hash_salt' => 'wukjvaRpxDI6WW3pO8W2Et4DD2z5rE0wL5fiC5',

	/**
	 * $_POST key for login username
	 */
	'username_post_key' => 'login_user_id',
